...
ItemBuilder.prototype = {
	...
	skillText: {
		...
		'ruby-damage': '+VVV Minimum and +VVV Maximum Damage',
	...
	init: function() {
	  ...
	  this.bindSetBonusSelect();
		this.gemEffect = d3up.gameData.gemEffects;
		if(!this.item) {
			this.item = {
				attrs: {},
				stats: {},
	...
	setItem: function(slot, item) {
		...
		if(this.item) {
			...
			this.item.itemClass = this.getItemClass(item.type)
			// Adjust the Set
