		...
		<div class='span9'>
			...
			<div class='content-page hero-unit'>
				...
				<ul>
					...
					<li>Localization Enabled - You can change from 'English' to 'Pig Latin' using the dropdown in the upper right of the menubar on the top (thanks to allan on #diablo!)</li>
				</ul>
