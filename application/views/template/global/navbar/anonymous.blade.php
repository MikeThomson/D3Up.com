		...
		<div class="container-fluid getting-started">
			...
			<div class="row-fluid">
				<div class="span6">
					...
					<p><a class="btn btn-block" href="/build/create">{{ __('d3up.create_character_build') }}</a></p>
					...
					<p><a class="btn btn-block" href="/guide/12/creating-your-build-on-d3up-com">Check out our guide on Creating Builds</a></p>
				</div>
				<div class="span6">
