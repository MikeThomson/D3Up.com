...
class D3Up_Signature {
	...
	public function __construct(D3Up_Build $build) {
		...
		$this->addShadowText("d3up.com", 10, 385, 14, "#fff", 'sans');
	...
	public function addShadowText($text, $size, $x, $y, $hex = "#fff", $font = "d3") {
		$this->addText($text, $size, $x-1, $y-1, "#000", $font);
		$this->addText($text, $size, $x+1, $y+1, "#000", $font);
		$this->addText($text, $size, $x+2, $y+2, "#000", $font);
		$this->addText($text, $size, $x, $y, $hex, $font);
	}
	 
	public function addText($text, $size, $x, $y, $hex = "#fff", $font = "d3") {
